...
export async function GET(request: Request): Promise<Response> {
  ...
  const supabaseUrl = `${SUPABASE_REST_URL}/guests?phone=eq.${encodeURIComponent(phone)}`;
...
export async function POST(request: Request): Promise<Response> {
  ...
  return forwardToSupabase("POST", `${SUPABASE_REST_URL}/guests`, body as Record<string, unknown>);
}
