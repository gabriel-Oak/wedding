...
/**
 * Generic query helper for server-side Supabase operations.
 */
...
/**
 * Insert helper for server-side Supabase operations.
 */
...
/**
 * Update helper for server-side Supabase operations.
 */
